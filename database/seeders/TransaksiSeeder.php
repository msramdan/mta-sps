...
class TransaksiSeeder extends Seeder
{
    ...
    {
        $merchantId = DB::table('merchants')->value('id');
        ...
        DB::table('transaksis')->insert([
            ...
            'no_referensi' => 'TRX' . now()->subHours(2)->format('YmdHis') . '0001',
            ...
            'callback' => json_encode([
                'status' => 'success',
                'transaction_id' => 'TRX' . now()->subHours(2)->format('YmdHis') . '0001',
        ...
        DB::table('transaksis')->insert([
            ...
            'merchant_id' => $merchantId,
            'no_referensi' => 'TRX' . now()->subMinutes(30)->format('YmdHis') . '0002',
        ...
        DB::table('transaksis')->insert([
            ...
            'merchant_id' => $merchantId,
            'no_referensi' => 'TRX' . now()->subDays(1)->format('YmdHis') . '0003',
            ...
            'callback' => json_encode([
                'status' => 'failed',
                'transaction_id' => 'TRX' . now()->subDays(1)->format('YmdHis') . '0003',
