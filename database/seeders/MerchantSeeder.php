...
class MerchantSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // ========== MERCHANT 3: BILLINGHUB PRIMARY ==========
        $merchantId3 = (string) Str::uuid();

        DB::table('merchants')->insert([
            'id' => $merchantId3,
            'kode_merchant' => 'QR000003',
        ...
        // ========== MERCHANT 4: BILLINGHUB CLIENT ==========
        $merchantId4 = (string) Str::uuid();

        DB::table('merchants')->insert([
            'id' => $merchantId4,
            'kode_merchant' => 'QR000004',
        ...
        $this->command->info('Seeder Merchant berhasil: 4 merchant dibuat dan di-assign ke user 1.');
    }
}
