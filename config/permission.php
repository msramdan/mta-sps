...
return [
    ...
    'permissions' => [
        ...
        ['group' => 'system log', 'access' => ['log generate qr view', 'log generate qr delete', 'log callback view', 'log callback delete', 'log resend callback view', 'log resend callback delete', 'log query payment status view', 'log query payment status delete', 'log token b2b view', 'log token b2b delete', 'activity log view', 'activity log delete']],
    ],
];
