...
<head>
    ...
    <meta name="description"
        content="Dashboard Admin QRIN - Kelola pembayaran QRIS, monitor transaksi, dan kontrol semua aspek payment gateway Anda dari satu platform terintegrasi.">
    <meta name="keywords"
        content="dashboard admin qris, admin panel payment gateway, dashboard qrin, admin pembayaran digital, manajemen transaksi qris, admin e-wallet, kontrol pembayaran">
    ...
    <meta property="og:description"
        content="Dashboard admin untuk mengelola payment gateway QRIS dengan semua fitur monitoring transaksi, manajemen user, dan laporan real-time.">
