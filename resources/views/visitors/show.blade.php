            ...
            <div class="row">
                <div class="col-lg-4 mb-3">
                    <div class="card h-100 shadow-sm">
                        <div class="card-body text-center d-flex flex-column align-items-center justify-content-center">
                            ...
                            <h5 class="mb-2 fw-bold">{{ $visitor->nama_rs }}</h5>
                            <span class="badge bg-primary mb-2">
                                <i class="ti ti-user me-1"></i>{{ $visitor->user?->name ?? '-' }}
                            </span>
                            <span class="badge bg-secondary">
                                <i class="ti ti-calendar me-1"></i>{{ $visitor->tanggal_visit?->format('d M Y') }}
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-8 mb-3">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="border rounded-3 p-3 h-100">
                                        ...
                                        <div class="fw-semibold">
                                            <a href="tel:{{ $visitor->no_telp_pic }}" class="text-decoration-none">{{ $visitor->no_telp_pic }}</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="border rounded-3 p-3 h-100">
                                        ...
                                        <div class="fw-semibold">{{ $visitor->tanggal_visit?->format('d F Y') }}</div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="border rounded-3 p-3">
                                        ...
                                        <div class="fw-semibold">{{ $visitor->keterangan }}</div>
                                    </div>
                                </div>
                                @endif
                            </div>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="border rounded-3 p-3 h-100">
                                        ...
                                        <div class="fw-semibold">{{ $visitor->created_at->format('d/m/Y H:i') }}</div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="border rounded-3 p-3 h-100">
                                        <div class="text-muted small mb-1">{{ __('Diperbarui pada') }}</div>
                                        <div class="fw-semibold">{{ $visitor->updated_at->format('d/m/Y H:i') }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        ...
                        @can('visitor edit')
                            <a href="{{ route('visitors.edit', $visitor->id) }}" class="btn btn-primary">
