                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body border-bottom py-2">
                            ...
                            <button type="button" id="btn-truncate-log" class="btn btn-outline-danger btn-sm ms-1" data-url="{{ route('log-callbacks.truncate') }}" data-name="Log Callback" title="{{ __('Kosongkan semua data log') }}">
