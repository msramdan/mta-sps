...
@section('title', __('Log Query Payment Status'))
...
@section('content')
    <main>
        <div class="container-fluid">
            <div class="row m-1">
                <div class="col-12">
                    <h4 class="main-title">{{ __('Log Query Payment Status') }}</h4>
                    <ul class="app-line-breadcrumbs mb-3">
                        ...
                        <li class="active">
                            <a class="f-s-14 f-w-500" href="#">{{ __('Log Query Payment Status') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <form method="GET" action="{{ route('log-query-payment-status.index') }}" id="form-filter" class="row g-3 align-items-end">
                        <div class="col-md-2">
...
@push('js')
    <script>
        var table = $('#data-table').DataTable({
            ...
            pageLength: 50,
            ajax: {
                url: "{{ route('log-query-payment-status.index') }}",
                data: function(d) {
