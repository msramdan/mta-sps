                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body border-bottom py-2">
                            <button type="button" id="btn-bulk-delete-log" class="btn btn-danger btn-sm" data-url="{{ route('log-generate-qrs.bulk-destroy') }}" title="{{ __('Hapus data terpilih') }}">
                                <i class="ti ti-trash"></i> {{ __('Hapus terpilih') }}
                            </button>
                            <button type="button" id="btn-truncate-log" class="btn btn-outline-danger btn-sm ms-1" data-url="{{ route('log-generate-qrs.truncate') }}" data-name="Log Generate QR" title="{{ __('Kosongkan semua data log') }}">
